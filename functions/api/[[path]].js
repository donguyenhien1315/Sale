...
function applyAction(root,action,p){
  ...
  switch(action){
    ...
    case "stockin.create": {
      ...
      if(r.totalCost>0)st.expenses.push({id:uid(),type:"stockin",method:String(p.method||"cash"),sourceId:r.id,amount:r.totalCost,note:`Nhập kho${r.note?": "+r.note:""}`,includeInProfit:false,createdAt:r.createdAt});
