...
function normalizeLegacyStore(input,name="Cửa hàng chính"){
  ...
  out.meta={...(out.meta||{}),name:out.meta?.name||name,version:"4.11.2"};
...
async function writeRoot(root){
  ...
  const token=uid();
  root.persist={token,writtenAt:now(),version:"4.11.2"};
